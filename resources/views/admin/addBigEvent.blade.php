                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary border-0">
                            <div class="card-header d-flex justify-content-between align-items-center"
                                ...
                                <h3 class="card-title mb-0 fs-5">ADD EVENT</h3>
                            ...
                            <form id="articleForm" class="form-group" method="post" action="{{ asset('events/add') }}"
                                    ...
                                    {{-- <div class="form-group row">
                                        <div class="input-field">
                                            <textarea autocomplete="off" name="sort_desc" placeholder=""
                                                id="sort_desc" oninput="clearError('sort_desc-error')" class="input-textarea">{{ old('sort_desc') }}</textarea>
                                        ...
                                        <div class="uploads col-md-5" id="video-thumb-upload-section">
                                            <div class="uploads-box">
                                                ...
                                                <label for="video-thumb-file-input" class="drop-container">
                                                    <input type="file" accept=".jpeg,.jpg,.png" name="video-thumb-file"
